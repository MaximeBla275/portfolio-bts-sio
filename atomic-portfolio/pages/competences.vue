  ...
  <PageWrapper>
    ...
    <div class="mb-14 p-6 md:p-8 border border-[var(--border)]">
      <div class="flex items-center justify-between mb-3">
        <span class="font-mono text-xs uppercase tracking-widest text-[var(--muted-light)]">Taux de couverture</span>
    ...
    <div class="mt-14 grid grid-cols-1 md:grid-cols-2 gap-6">
      <div class="border border-[var(--border)] p-6">
        <h3 class="font-mono text-xs uppercase tracking-widest text-[var(--muted-light)] mb-4">Légende</h3>
        <div class="space-y-2">
      ...
      <div class="border border-[var(--border)] p-6">
        <h3 class="font-mono text-xs uppercase tracking-widest text-[var(--muted-light)] mb-2">Épreuves E4 / E5</h3>
