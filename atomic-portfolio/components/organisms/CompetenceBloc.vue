<template>
  <div>
    ...
    <div class="border border-[var(--border)] overflow-hidden hidden md:block">
      <div class="grid grid-cols-12 block-inv px-4 py-3">
      ...
      >
        ...
        <span class="col-span-5 font-mono text-sm leading-relaxed pr-4">{{ comp.libelle }}</span>
    ...
    <div class="md:hidden space-y-2">
      ...
      >
        ...
        <p class="font-mono text-sm leading-relaxed mb-2">{{ comp.libelle }}</p>
